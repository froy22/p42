...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_default(
    ...
    XXXXXXX, XXXXXXX, KC_SPC,  XXXXXXX,  XXXXXXX, KC_SPC,  MO(10),  MO(11),  XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [3] = LAYOUT_default(
    RESET,   TG(12),  TG(0),   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  ...
  [4] = LAYOUT_default(
    ...
    XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_VOLD, KC_VOLU, KC_MPLY, XXXXXXX, XXXXXXX,
  ...
  [10] = LAYOUT_default(
    KC_ACL0, KC_ACL1, KC_ACL2, XXXXXXX, XXXXXXX, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, XXXXXXX,
    XXXXXXX, KC_BTN3, KC_BTN2, KC_BTN1, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_DEL,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [12] = LAYOUT_default(
    ...
    KC_A,    KC_S,    KC_D,    KC_F,  KC_G,   KC_H,   KC_J,    KC_K,    KC_L,   KC_SCLN,
    KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,   KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, MO(5),
    KC_LCTL, KC_LGUI, KC_LALT, MO(13), KC_ENT, KC_SPC, KC_LSFT, MO(2),   MO(6),  MO(4),  MO(8)
  ),

  [13] = LAYOUT_default(
    KC_1,    KC_2,    KC_3,    KC_4,     KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    KC_LCTL, KC_LGUI, KC_LALT, KC_ESC,   KC_TAB,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSPC,
    KC_LSFT, XXXXXXX, CK_LTAB, CK_RTAB,  XXXXXXX, XXXXXXX, KC_ENT,  XXXXXXX, KC_DOT,  KC_RSFT, XXXXXXX,
    XXXXXXX, XXXXXXX, KC_SPC,  XXXXXXX,  XXXXXXX, KC_SPC,  MO(10),  MO(11),  XXXXXXX, XXXXXXX, XXXXXXX
  )
};
