...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_default(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, MO(1), LT(7, KC_ENT), LT(8, KC_SPC), MO(2), KC_LSFT, MO(6),  MO(4),   MO(10)
  ),

  [1] = LAYOUT_default(
    KC_ESC,  CK_SMBS, KC_UP,   CK_BGBS, XXXXXXX, XXXXXXX, KC_1,    KC_2, KC_3,   KC_DEL,
    KC_LGUI, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, KC_4,    KC_5, KC_6,   KC_BSPC,
    KC_LCTL, CK_REDO, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_7,    KC_8, KC_9,   XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, KC_SPC,  XXXXXXX, XXXXXXX, KC_SPC,  KC_LSFT, KC_0, KC_DOT, XXXXXXX, XXXXXXX
  ),

  [2] = LAYOUT_default(
    KC_ZKHK, XXXXXXX, KC_UP,   XXXXXXX, XXXXXXX, XXXXXXX, CK_LPRT, CK_RPRT, KC_MINS, KC_EQL,
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, KC_SPC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MO(3)
  ),
  ...
  [7] = LAYOUT_default(
    ...
    CK_SWAPP, XXXXXXX, XXXXXXX, CK_UNDO, CK_REDO, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, CK_SMBS,
    XXXXXXX,  XXXXXXX, XXXXXXX, CK_LTAB, CK_RTAB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ENT,  XXXXXXX,
  ...
  [8] = LAYOUT_default(
    ...
    KC_LSFT, CK_LAMV, XXXXXXX, CK_RAMV, XXXXXXX, XXXXXXX, MO(9),   XXXXXXX, XXXXXXX, CK_SMBS,
    KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ENT,  XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
